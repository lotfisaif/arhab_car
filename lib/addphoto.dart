...
class MyAppAdd extends StatefulWidget {
  static String id = "MyAppAdd";

  @override
  _MyAppAddState createState() => _MyAppAddState();
}

class _MyAppAddState extends State<MyAppAdd> {
                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          InkWell(
                            child: WidgettApp("AstonMartin ", setAstonMartin17),
                            onTap: () {
                              setState(() {
        ...
        if (snapshot.hasData) {
          ...
          try {
            for (int i = 0; i < productscar.length; i++) {
              for (int j = 0; j < productscar[i].imageUrlsCar.length; j++) {
                _listOfImages.add(NetworkImage(productscar[i].imageUrlsCar[j]));
              }
            }
          } on Error catch (ex) {
            print(ex);
